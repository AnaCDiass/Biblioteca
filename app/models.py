...
nome = models.CharField(max_length=100, verbose_name="Nome da
cidade")
...
nome = models.CharField(max_length=100, verbose_name="Nome da
editora")
site = models.CharField(max_length=100, verbose_name="Site da
editora")
cidade = models.ForeignKey(Cidade, on_delete=models.CASCADE,
...
nome = models.CharField(max_length=100, verbose_name="Nome do
leitor")
email = models.CharField(max_length=100, verbose_name="Email do
leitor")
...
data_plub = models.DateField(verbose_name="Data de publicação do
livro")
